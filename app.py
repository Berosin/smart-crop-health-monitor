...
def render_home() -> None:
    ...
    feats = [
        ("🦠", "Detect diseases", "Upload a leaf image; the AI flags diseases with confidence and severity."),
        ("🌡️", "Track conditions", "Log temperature, humidity, soil moisture and rainfall."),
        ("🌱", "Score crop health", "Combine the image and environmental signals into one health score."),
        ("📊", "Visualize trends", "See stats and charts across all your past analyses."),
        ("🗂️", "Keep history", "Every analysis is stored so you can review it later."),
    ]
